  ...
  return (
    <footer className="border-t border-slate-200 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid gap-8 md:grid-cols-3">
        <div>
          <h3 className="text-lg font-semibold text-slate-900">Veridia.io</h3>
          <p className="mt-2 text-sm text-slate-600">We design, develop, and deliver end-to-end tech solutions with a focus on quality, innovation, and reliability.</p>
        </div>
