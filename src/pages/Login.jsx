    ...
    <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <form onSubmit={submit} className="mt-6 rounded-xl border border-slate-200 bg-white/80 backdrop-blur p-6 shadow-sm space-y-4">
        <div>
          ...
          <input
            type="email"
            className="w-full bg-custom-cream border border-slate-200 rounded-lg px-4 py-2"
            value={email}
        ...
        <button
          type="submit"
          disabled={loading}
          className="inline-flex w-full justify-center rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 disabled:opacity-60"
        >
